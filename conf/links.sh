...
generateLinkBlock() {
if [ "$6" = "" ]; then
    echo "<die value=\"Wrong configured link block. Please check your configs! For details see: https://github.com/adam-/inspircd-docker#linking-servers-and-services\">"
    exit 1
fi
cat <<EOF
<link name="${1}"
